...
[Completar: hallazgos de `domain-security-check` o del skill `/security-review` — nunca dejar un endpoint sensible sin gate de auth documentado explícitamente como decisión, ver R-SEC-* en `.claude/rules/seguridad-y-secretos.md`.]
